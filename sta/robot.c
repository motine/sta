...
// processes the given action by...
// - ...setting next_x and next_y
// - ...performing error checking (and calling error() if necessary)
// - ...setting robot_has_box
// - ...setting spaces[][] items
